...
public class AccessBDGen {
   ...
   public static Connection connecter(String bd, String user, String pass)
      ...
      try {
         ...
         connexion = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/" + bd, user, pass);
    ...
    * et r�cup�re le mod�le des donn�es r�sultant de la requ�te (ensemble de lignes
    * et de colonnes)
    */
